...
organizations:
  - name: School of Mathematical Sciences , Beijing Normal University
    url: https://math.bnu.edu.cn/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:DongYZ@mail.bnu.edu.cn'
    label: E-mail Me
  - icon: brands/github
    url: https://github.com/abstract-5
...
Dong Yuzheng now is a fourth-year undergraduate student in the School of Mathematical Sciences at Beijing Normal University, pursuing a Ph.D offer.
